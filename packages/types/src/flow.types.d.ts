...
export type NodeConfig = TriggerNodeConfig | SendMessageNodeConfig | WaitResponseNodeConfig | ConditionNodeConfig | DelayNodeConfig | WebhookCallNodeConfig | AssignTagNodeConfig | EndNodeConfig;
